...
directiveModule.directive('tweetShare', function(){
  return{
    restrict:'E', 
    template:'<a href="https://twitter.com/intent/tweet?text=lulz&url='+ encodeURIComponent(window.location.href)+'&via=dannorton" target="_blank"><i class="fa fa-twitter"></i></a>'
  }
});
var noContextController = function($scope,$http,$timeout,$sce,$routeParams,$location,$document){
  ...
  $scope.getSubreddits = function(){
    ...
    $.getJSON("http://www.reddit.com/reddits/me.json", function( postData ) { 
